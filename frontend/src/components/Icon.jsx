// 全站统一细线条 SVG 图标（替代 emoji 图标堆）
// 线稿风格：stroke 1.8 / 圆角端点，跟随 currentColor 适配明暗主题
const PATHS = {
  book: (
    <>
  ...
  flask: (
    <>
      <path d="M10 2v7.5a2 2 0 0 1-.21.9L4.72 20.55a1 1 0 0 0 .9 1.45h12.76a1 1 0 0 0 .9-1.45l-5.07-10.13A2 2 0 0 1 14 9.5V2" />
      <path d="M8.5 2h7" />
      <path d="M7 16h10" />
    </>
  ),
